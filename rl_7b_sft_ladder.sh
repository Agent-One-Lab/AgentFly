#!/bin/bash
#SBATCH --job-name=rl_7b_sft_ladder
#SBATCH --account=iq
#SBATCH --nodes=2
#SBATCH --ntasks=2
...
#SBATCH --output=slurm/rl_7b_sft_ladder_%j.log
#SBATCH --error=slurm/rl_7b_sft_ladder_%j.err
...
bash examples/train_scripts/run_code_vlm_as_judge_reward_ladder_base_7b_deepseek_sft_single_sft.sh