#!/bin/bash
#SBATCH --job-name=rl_7b_sft_major
#SBATCH --account=iq
#SBATCH --nodes=2
#SBATCH --ntasks=2
...
#SBATCH --output=slurm/rl_7b_sft_major_%j.log
#SBATCH --error=slurm/rl_7b_sft_major_%j.err
...
bash examples/train_scripts/run_code_vlm_as_judge_reward_major_vote_base_7b_deepseek_sft_single_sft.sh