...
async def chess_puzzle_reward(prediction: str, env: ChessPuzzleEnv) -> Dict[str, Any]:
    ...
    output_parts = [
        ...
        f"Best move matches: {best_move_matches}/{num_moves}" if num_moves > 0 else "No moves made",
...
@reward(
    name="chess_puzzle_reward_simple",
    env_cls=ChessPuzzleEnv,
    pool_size=8
)
async def chess_puzzle_reward_simple(prediction: str, env: ChessPuzzleEnv) -> Dict[str, Any]:
    """
