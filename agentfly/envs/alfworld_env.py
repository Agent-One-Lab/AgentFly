...
import time
import random
from typing import Any, Tuple, Mapping, Dict, List, Optional
...
class ALFWorldEnv(BaseEnv, SupportsDocker):
    ...
    async def get_available_tasks(self, split: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    async def reset(self, env_args = None, split: Optional[str] = None) -> Tuple[str, Dict[str, Any]]:
        """
    ...
    async def get_info(self) -> Dict[str, Any]:
        ...
        if self._current_info:
            ...
            goal = (self._current_info.get('goal') or 
                    self._current_info.get('task_description') or
                    self._current_info.get('task_desc') or
                    self._current_info.get('description') or '')
