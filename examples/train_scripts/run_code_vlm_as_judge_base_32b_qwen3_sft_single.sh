...
model=${MODEL:-/mnt/weka/shrd/ad/haonan.li/ViPhy/new_models/qwen3-32b_sft-single}
## Todo: add template
...
tools=${TOOLS:-[answer]}
reward_name=${REWARD_NAME:-vlm_as_judge_pass_reward_multi_model}

experiment_name=${EXPERIMENT_NAME:-vlm_as_judge_base_32b_qwen3_sft_single}
