...
# Run Code Agent training with VLM-as-Judge reward
# Notes:
...
model=${MODEL:-/mnt/sharefs/users/haonan.li/ViPhy/models/deepseek-r1-distill-qwen-7b_sft2_prompt_3000_openthought_9000}
## Todo: add template
template=${TEMPLATE:-deepseek-r1-distill-qwen}

# Data paths (must contain fields: question, vlm_questions)
train_file=${TRAIN_FILE:-/mnt/weka/home/yongxin.wang/workspace/Agent-One-Lab/AgentFly/data/RL_processed.json}
val_file=${VAL_FILE:-/mnt/weka/home/yongxin.wang/workspace/Agent-One-Lab/AgentFly/data/val.json}
...
tools=${TOOLS:-[answer]}
reward_name=${REWARD_NAME:-llm_as_judge_pass_reward}

experiment_name=${EXPERIMENT_NAME:-llm_as_judge_acc_mixed_sft_7b}
