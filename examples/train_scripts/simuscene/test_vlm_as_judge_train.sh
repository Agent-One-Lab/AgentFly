...
model="/mnt/weka/shrd/ad/haonan.li/ViPhy/new_models/deepseek-r1-distill-qwen-7b_sft-single"
...
max_turns=1
project_name="SimuScene"
total_training_steps=300

# Agent config
agent_type="hf"
tools="[answer_qa]"
reward_name="vlm_as_judge_pass_reward_multi_model"

experiment_name="test_vlm_as_judge"
