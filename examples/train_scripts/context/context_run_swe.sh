...
# Directory holding the r2e-gym-lite enroot images. See docs/examples/swe.md.
export ENROOT_IMAGES_PATH=${ENROOT_IMAGES_PATH:-/path/to/enroot/images/r2e-gym-lite}
