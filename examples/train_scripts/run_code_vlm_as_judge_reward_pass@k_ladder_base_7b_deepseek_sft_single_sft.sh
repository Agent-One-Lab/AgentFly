...
train_file=${TRAIN_FILE:-/mnt/weka/home/yongxin.wang/workspace/human_modify/sft_single.json}
...
reward_name=${REWARD_NAME:-vlm_as_judge_pass_reward_multi_model_pass_at_3_ladder}

experiment_name=${EXPERIMENT_NAME:-vlm_as_judge_reward_pass@k_ladder_base_7b_deepseek_sft_single_sft}
