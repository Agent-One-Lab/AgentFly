...
model=${MODEL:-/mnt/sharefs/users/haonan.li/ViPhy/models/deepseek-r1-distill-qwen-7b_sft1}
## Todo: add template
template=${TEMPLATE:-deepseek-r1-distill-qwen}

# Data paths (must contain fields: question, vlm_questions)
train_file=${TRAIN_FILE:-/mnt/sharefs/users/haonan.li/ViPhy/finaldata1/RL_format/merged_reformatted.json}
val_file=${VAL_FILE:-/mnt/sharefs/users/haonan.li/ViPhy/finaldata1/RL_format/val_reformatted.json}
...
tools=${TOOLS:-[answer]}
reward_name=${REWARD_NAME:-vlm_as_judge_pass_reward_rebuttal}

experiment_name=${EXPERIMENT_NAME:-vlm_as_judge_acc_sft_7b_rebuttal}
